...
<!--                    Вывод массива с ошибками-->
                ...
                <div class="col mb-4">
                    ...
                    <input id="post_title" value="<?=$post['title']?>" name="title" type="text" class="form-control" aria-label="Название статьи">
                </div>
                <div class="col">
                ...
                <div class="form-check col mb-2">
                    <?php if (empty($post['status']) && $post['status'] == 0): ?>
                    ...
                    <?php else: ?>
                        <input class="form-check-input" type="checkbox" name="publish" id="PublishCheckbox" checked>
                        <label class="form-check-label" for="PublishCheckbox">Publish</label>
                    <?php endif; ?>
                </div>
                <div class="col col-6">
                    <button name="post_edit" class="btn btn-primary" type="submit">Сохранить запись</button>
                </div>
            </form>
        </div>
    </div>
